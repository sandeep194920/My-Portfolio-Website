...
function Footer() {
  return (
    <footer className="relative flex items-center justify-center bg-primary-clr bg-opacity-50 text-xs text-white sm:text-sm">
      {/* row */}
      <div className="m-auto mb-[3rem] mt-10 flex w-[90%] flex-col items-center justify-center gap-0 sm:mb-[3rem] sm:mt-14 sm:flex-row sm:flex-wrap sm:justify-start sm:gap-11 lg:justify-center">
